            ...
            <div className="container mx-auto px-6 pt-32 pb-20">
                ...
                <div className="text-center">
                    ...
                    <div className="flex justify-center gap-8">
                        <a href="https://github.com/SmaranNadig/elsem3" target="_blank" rel="noopener noreferrer" className="p-4 rounded-full bg-[#151516] border border-white/5 hover:border-brand-blue hover:text-brand-blue transition-colors group">
                            <Github className="w-6 h-6 group-hover:scale-110 transition-transform" />
                        </a>
                        <a href="mailto:elnn736@gmail.com" className="p-4 rounded-full bg-[#151516] border border-white/5 hover:border-emerald-500 hover:text-emerald-500 transition-colors group">
